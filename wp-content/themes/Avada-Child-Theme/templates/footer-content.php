...
<?php if ( fusion_get_option( 'footer_widgets' ) ) : ?>
	...
	?>
	<img class="footerPattern desktop" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/house-footer.svg" alt="">
	<img class="footerPattern mobile" style="display:none;" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/house-footer-mobile.svg" alt="">
	<footer class="fusion-footer-widget-area fusion-widget-area<?php echo esc_attr( $footer_widget_area_center_class ); ?>">
		<div class="fusion-row">
			<div class="footerTop">
				<?php dynamic_sidebar('avada-custom-sidebar-footerbooknow'); ?>
			</div>
			<div class="footerMiddle text-center">
				<a href="<?php echo site_url(); ?>"><img style="max-height:70px;" src="<?php echo site_url(); ?>/wp-content/uploads/2022/02/form-footer-logo.svg" alt=""></a>				
			</div>
